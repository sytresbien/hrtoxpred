def model_opts(parser):
    parser.add_argument("--embedding", choices=["word", "word_pos", "word_pos_seg", "word_sinusoidalpos", "dual", "smiles"], default="word_pos_seg",
                        help="Emebdding type.")
...
def finetune_opts(parser):
    ...
    parser.add_argument("--output_model_path", default="finetuned.bin", type=str,
    ...
    parser.add_argument("--finetune_target", default=None, type=str)
    parser.add_argument("--pred_path", default=None, type=str)
    parser.add_argument("--attention_output", default=None, type=str)
    parser.add_argument("--target_output", default=None, type=str)
